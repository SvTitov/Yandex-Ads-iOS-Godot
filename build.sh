...
build_ios() {
  ...
  # MARK specific command for copying YandexMobileAds
	COPY_COMMANDS+=("cp -af ""$product_path/YandexMobileAds.framework ""$BINARY_PATH_IOS")
